...
let guestsList = ["Aqeel Ahmad", "Muhammad Zafir", "Waqas Wain", "Muhammad Rizwan"];
...
let updatedGuests = [...guestsList];
let guestWhoCantMakeIt = "Waqas Wain"; // Assuming Waqas Wain not coming
let indexToRemove = updatedGuests.indexOf(guestWhoCantMakeIt);
if (indexToRemove !== -1) {
